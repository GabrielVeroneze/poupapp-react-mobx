        ...
        <Section>
            <SectionWrapper>
                <Container>
                    ...
                    <Description>
                        Boas-vindas à plataforma que protege seu bolso! Antes de
                        começar, precisamos de algumas informações sobre sua
                        rotina financeira. Vamos lá?
                    </Description>
                    <Form>
                        <Fieldset>
                            ...
                            <RadioGroup>
                                <RadioInput>
                                    <input
                                        ...
                                        value="economizar"
                                        checked={
                                            objetivoFinanceiro === 'economizar'
                                        }
                                        onChange={(e) =>
                                            setObjetivoFinanceiro(
                                                e.target.value,
                                            )
                                        }
                                    />
                                    <Label htmlFor="economizar">
                                        Economizar
                                    </Label>
                                </RadioInput>
                                <RadioInput>
